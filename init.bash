...
if [ -z "${DOCKER_ROS_ROOTLESS+x}" ]; then
  DOCKER_ROS_ROOTLESS=$(ask_yes_no "Enable rootless mode?" "Yes")
else
  DOCKER_ROS_ROOTLESS=$([ "$DOCKER_ROS_ROOTLESS" = "true" ] && echo "true" || echo "false")
fi
